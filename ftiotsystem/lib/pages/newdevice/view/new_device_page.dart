...
class NewDevicePage extends StatefulWidget {
  ...
  @override
  _NewDevicePageState createState() => new _NewDevicePageState();
}

class _NewDevicePageState extends State<NewDevicePage> with AfterLayoutMixin<NewDevicePage> {
