...
class GuideDirectlyScenarioPage extends StatefulWidget {
  const GuideDirectlyScenarioPage({
    Key key,
  ...
  @override
  _GuideDirectlyScenarioPageState createState() => new _GuideDirectlyScenarioPageState();
}

class _GuideDirectlyScenarioPageState extends State<GuideDirectlyScenarioPage> with AfterLayoutMixin<GuideDirectlyScenarioPage>, TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Directly Scenario 1/4'),
